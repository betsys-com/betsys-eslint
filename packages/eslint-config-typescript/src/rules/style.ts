...
const config: TSESLint.Linter.Config = {
    rules: {
        ...
        '@typescript-eslint/indent': [
            ...
            4,
            {
                // ignores issue with decorators https://github.com/typescript-eslint/typescript-eslint/issues/1824
                ignoredNodes: [
        ...
        'no-restricted-syntax': [
            'error',
            {
                ...
                which is virtually never what you want. Use Object.{keys,values,entries}, and iterate over the resulting array.`,
            },
            {
